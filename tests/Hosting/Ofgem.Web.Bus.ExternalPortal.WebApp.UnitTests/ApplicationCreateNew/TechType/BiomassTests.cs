...
[TestFixture]
public class BiomassTests : PageModelTestsBase
{
    private BiomassSpecModel _systemUnderTest;
    protected Mock<ILogger<BiomassSpecModel>> _mockLogger = new();

    [SetUp]
    public override void TestCaseSetUp()
    {
        _systemUnderTest = new BiomassSpecModel(_mockLogger.Object);
        base.TestCaseSetUp();
    }
    ...
    public void OnGet_Should_Load_Form_Values_From_Session()
    {
        ...
        using (new AssertionScope())
        {
            ...
            session?.BiomassEligible.Should().BeTrue();
    ...
    [Test]
    public void OnPost_Should_Add_Page_Model_Values_To_Session_Model_And_GoTo_InstallPostcode()
    {
        // Arrange
        var sessionModel = new CreateApplicationModel();
        Session.Put(AbstractFormPage.PageModelSessionKey, sessionModel);
        ...
        using (new AssertionScope())
        {
            ...
            sessionModel?.BiomassEligible.Should().BeTrue();
        }
    }
    ...
    public void OnPost_Should_Errors_From_Lack_Of_User_Response()
    {
        ...
        _systemUnderTest.ModelState.AddModelError(nameof(BiomassSpecModel), "Tell us whether your project will meet these further requirements");
