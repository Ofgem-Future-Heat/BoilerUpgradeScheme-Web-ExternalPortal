...
[TestFixture]
public class EligibleBuildTests : PageModelTestsBase
{
    private EligibleBuildModel _systemUnderTest;
    protected Mock<ILogger<EligibleBuildModel>> _mockLogger = new();

    [SetUp]
    public override void TestCaseSetUp()
    {
        _systemUnderTest = new EligibleBuildModel(_mockLogger.Object);
        base.TestCaseSetUp();
    }
    ...
    {
        // Arrange and Act.
        var action = () => new EligibleBuildModel(null!);
    ...
    public void OnGet_Should_Load_Form_Values_From_Session()
    {
        ...
        {
            session?.IsEligibleSelfBuild.Should().BeTrue();
    ...
    [Test]
    public void OnPost_Should_Add_Page_Model_Values_To_Session_Model_And_GoTo_Offline_If_Yes()
    {
        // Arrange
        var sessionModel = new CreateApplicationModel
        {
        ...
        using (new AssertionScope())
        {
            ...
            sessionModel.IsEligibleSelfBuild.Should().BeTrue();
        }
    }

    [Test]
    public void OnPost_Should_Add_Page_Model_Values_To_Session_Model_And_GoTo_DropOut_If_No()
    {
        // Arrange
        var sessionModel = new CreateApplicationModel();
        Session.Put(AbstractFormPage.PageModelSessionKey, sessionModel);
    ...
    public void OnPost_Should_Errors_From_Lack_Of_User_Response()
    {
        ...
        _systemUnderTest.ModelState.AddModelError(nameof(EligibleBuildModel), "Tell us whether the property is an eligible self build");
