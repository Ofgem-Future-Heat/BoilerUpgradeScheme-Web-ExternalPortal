...
[PageHistory]
public class EligibleBuildHaltModel : AbstractFormPage
{
    /// <summary>
    /// Logging for instrumentation of code. 
    /// </summary>
    private readonly ILogger<EligibleBuildHaltModel> _logger;
    ...
    public EligibleBuildHaltModel(ILogger<EligibleBuildHaltModel> logger)
    {
